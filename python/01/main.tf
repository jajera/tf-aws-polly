...
data "archive_file" "create_update_function" {
  type        = "zip"
  output_path = "${path.module}/external/create_update_function.zip"
  source_file = "${path.module}/external/create_update/app.py"
}
